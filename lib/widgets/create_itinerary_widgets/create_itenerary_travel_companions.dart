...
class _CreateIteneraryTravelCompanionsState
  ...
  Future<void> fetchCategories() async {
    try {
      ...
      final response = await http.get(Uri.parse('$baseurl/app/travel-companions/$userToken'));
      ...
      if (response.statusCode == 200) {
        ...
        //setState(() {
          ...
          companienSelectBoolList = List.generate(data.length, (index) => index == 0);
        //});
                  ...
                  companienSelectBoolList.length,
                    ...
                    return travelCompanionCard(
                      ...
                      travelCompanionData.isNotEmpty
                          ? travelCompanionData[index]['travel_companion_name']
                          : '',
                      'profile.svg',
                    );
                  },
  ...
  Widget travelCompanionCard(int index, String title, String icon) {
    return Container(
